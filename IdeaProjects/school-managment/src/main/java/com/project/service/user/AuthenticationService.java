...
public class AuthenticationService {
    ...
    public ResponseEntity<AuthResponse> authenticateUser(LoginRequest loginRequest){
        ...
        //*************Bu ulaşılan kullanıcı dbdeki kullanıcı mı?
        ...
        ////***************Kullanıcı sadece username ve password girdi o halde rolü zaten db de kayıtlı değil mi?
    ...
    // Not: updatePassword() *****************************************
    //************bu metotta HttpServletRequest tarzında bir parametreye neden ihtiyaç duyduk
    public void updatePassword(UpdatePasswordRequest updatePasswordRequest, HttpServletRequest request) {
        ...
        //built_in() metodunu neden kullandık?
        //Super user ile ilgili bir durum mu? Super User şifresini hiç güncelleyemez mi?
