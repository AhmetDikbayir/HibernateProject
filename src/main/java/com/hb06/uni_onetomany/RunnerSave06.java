...
public class RunnerSave06 {
    public static void main(String[] args) {
        ...
        student1.setId(1001);
        student1.setName("Muhammed");
        student1.setGrade(10);

        Student06 student2 = new Student06();
        student2.setId(1002);
        student2.setName("Mirac");
        student2.setGrade(1);

        Student06 student3 = new Student06();
        student3.setId(1003);
        student3.setName("Ayse");
        student3.setGrade(11);

        Book06 book1 = new Book06();
        book1.setId(101);
        book1.setName("Muhammed bey in kitabi");

        Book06 book2 = new Book06();
        book2.setId(102);
        book2.setName("Muhammed bey in kitabi");

        Book06 book3 = new Book06();
        book3.setId(103);
        book3.setName("Mirac bey in kitabi");

        //student üzerinden veri setleme işlemleri :
